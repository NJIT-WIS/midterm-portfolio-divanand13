...
// Expected constants
const expectedTitle = "Divjot Anand's Personal Portfolio";
const expectedLogoText = 'Divjot Anand';
const expectedMenuItemCount = 1;
const expectedHeroTitle = 'Hello, I am Divjot Anand';
const expectedHeroSubText = 'Web Development/Cyber Security';
const expectedHeroLinkCount = 1;
const expectedFirstTitle = 'About Me';
const expectedSecondTitle = 'Projects';
const expectedAboutTitle = 'About Me';
const expectedProjectTitle = 'Projects';
...
const expectedNavs = ['About Me/Projects'];
const expectedAlts = ['Featured in fcompany', 'Featured in forbes', 'Featured in mit', 'Featured in tcrunch'];
const expectedNames = ['Divjot Anand'];
const expectedFooterLinks = ['linkedin', 'github'];
const expectedIcons = ['fab fa-linkedin', 'fab fa-github'];
